...
9. **SSH to the Server:**
   ...
   ```
10. **Copy the configuration script and tutorials:**
   ```
   cp -r -a /CMC/* /home/username
   cd /home/username/untether
   ```
11. **Change permission of your directory and files**
   ```
   chmod-R a+rwx /home/username/untether
   ```
   
12. **Check Available Accelerators:**
...
13. **Running the Docker Containers:**
